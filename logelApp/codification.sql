...
ALTER TABLE `chambre`
  ...
  ADD FOREIGN KEY `fk_nomPavillon` (`nomPavillon`),
  ADD FOREIGN KEY `numeroChambre` (`numeroChambre`);
--
-- Index pour la table `codifChambre`
--
ALTER TABLE `codifChambre`
  ADD PRIMARY KEY (`idCodif`),
  ADD FOREIGN KEY `fk_idPersonnel` (`idPersonnel`),
  ADD FOREIGN KEY `fk_numeroEtudiant` (`numeroCarte`);

ALTER TABLE `lingerie`
  ADD PRIMARY KEY (`idLing`),
  ADD FOREIGN KEY `fk_lingerie` (`numeroCarte`);  
...
ALTER TABLE `paiement`
  ...
  ADD FOREIGN KEY `fk_idCompte` (`idCompte`),
  ADD FOREIGN KEY `fk_idCodification` (`idCodification`);
