...
CREATE TABLE `compte` (
  ...
  FOREIGN KEY('typeProfil') REFERENCES `profil`('id')
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `compte` (`idCompte`, `mail`, `motDePasse` ,`typeProfil`, `actif`) VALUES
(1, 'fall.peindafall@gmail.com', 'passer', 2, 1),
(2, 'annie.anniediop@gmail.com', 'passer', 3, 1),
(3, 'cheikh.cheikhmbacke@gmail.com', 'passer', 2, 1),
(4, 'fall.jeanfall@gmail.com', 'passer', 4, 1),
(5, 'abdoul.abdoulkande@gmail.com', 'passer', 2, 1);
...
(2, '201607lki', '2 draps et 1 couette');
...
CREATE TABLE `pavillon` (
  `nomPavillon` varchar(50) NOT NULL,
  `chefPav` int(11),
  FOREIGN KEY('chefPav') REFERENCES `personnel`(`idPersonnel`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `personnel`
  ADD CONSTRAINT `fk_idCompte_Personnel` FOREIGN KEY (`idCompte`) REFERENCES `compte` (`idCompte`);
...
--
-- Contraintes pour la table `lingerie`
--
...
ALTER TABLE `paiement`
  ...
  ADD CONSTRAINT `fk_idCompte_paiement` FOREIGN KEY (`idCompte`) REFERENCES `compte` (`idCompte`);
--
