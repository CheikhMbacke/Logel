...
?>
    ...
    <?php
        while ($data = $pavillons->fetch()) {
            ...
            <a href='/codif/project/codification/Logel-cheikh/views/get_rooms.php?nomPav=<?php echo $data["nomPavillon"];?>' style="float:right">Voir les chambres</a>
            </li>
        <?php } ?>
    </ul>

    <a href="/codif/project/codification/Logel-cheikh/views" class="btn btn-info sm mt-5">< BACK</a>
